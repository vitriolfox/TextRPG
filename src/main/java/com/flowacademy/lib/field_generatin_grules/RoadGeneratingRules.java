package com.flowacademy.lib.field_generatin_grules;
...
public class RoadGeneratingRules {

        public static void roadsNorth(){
            ...
            for (int i=1; i<north5List.length; i++){
                ...
                if (north5List[i]!=null && north5List[i].getMapSign().equals("R") && map.get(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX-5+i+randomCoordinateVariable, actualY-6)) == null) {

                    if (north5List[i].getMapSign().equals("R")) {

                        map.put(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX - 5 + i + randomCoordinateVariable, actualY - 6), new Roads(actualX - 5 + i + randomCoordinateVariable, actualY - 6));
                    }

                } else if (north5List[i]!=null && north5List[i].getMapSign().equals("B") && map.get(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX-5+i+randomCoordinateVariable, actualY-6)) == null){
        ...
        public static void roadsSouth(){
            ...
            for (int i=1; i<south5List.length; i++){
                ...
                if (south5List[i]!=null && south5List[i].getMapSign().equals("R") && map.get(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX-5+i+randomCoordinateVariable, actualY+6)) == null){

                    if (south5List[i].getMapSign().equals("R")) {

                        map.put(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX - 5 + i + randomCoordinateVariable, actualY + 6), new Roads(actualX - 5 + i + randomCoordinateVariable, actualY + 6));
                    }

                } else if (south5List[i]!=null && south5List[i].getMapSign().equals("B") && map.get(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX-5+i+randomCoordinateVariable, actualY+6)) == null){
        ...
        public static void roadsEast(){
            ...
            for (int i=1; i<east5List.length; i++){
                ...
                if (east5List[i]!=null && east5List[i].getMapSign().equals("R") && map.get(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX+6, actualY-5+i+randomCoordinateVariable)) == null){

                    if (east5List[i].getMapSign().equals("R")) {

                        map.put(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX+6, actualY-5+i+randomCoordinateVariable), new Roads(actualX+6, actualY-5+i+randomCoordinateVariable));
                    }

                } else if (east5List[i]!=null && east5List[i].getMapSign().equals("B") && map.get(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX+6, actualY-5+i+randomCoordinateVariable)) == null){
        ...
        public static void roadsWest() {
            ...
            for (int i = 1; i < west5List.length; i++) {
                ...
                if (west5List[i] != null && west5List[i].getMapSign().equals("R") && map.get(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX - 6, actualY - 5 + i + randomCoordinateVariable)) == null) {

                    if (west5List[i].getMapSign().equals("R")) {

                        map.put(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX-6, actualY-5+i+randomCoordinateVariable), new Roads(actualX-6, actualY-5+i+randomCoordinateVariable));
                    }

                } else if (west5List[i]!=null && west5List[i].getMapSign().equals("B") && map.get(GameFieldKeyGenerator.gameFieldKeyGenerator(actualX-6, actualY-5+i+randomCoordinateVariable)) == null){
